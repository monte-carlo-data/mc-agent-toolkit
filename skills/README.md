...
| **[CTP Config](ctp-config/)** | Build a CTP (Credential Transform Pipeline) config for a Monte Carlo connection type. Fetches live connector schemas and transform steps from the apollo-agent repo. |
