"""Codex adapter tests for pre_commit_hook — tests JSON format only."""
import json
import pytest
...
class TestPreCommitHookCodexAdapter:
    def test_context_output_format(self, capsys):
        """Context result should produce Codex additionalContext format."""
